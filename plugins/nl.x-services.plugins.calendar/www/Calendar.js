...
Calendar.prototype.createCalendarEvent = function (title, location, notes, startDate, endDate, successCallback, errorCallback) {
 cordova.exec(successCallback, errorCallback, "Calendar", "createCalendarEvent", [{
    "title": title,
    "location": location,
    "notes": notes,
...
Calendar.prototype.testButton = function(successCallback, errorCallback){
cordova.exec(successCallback, errorCallback, "Calendar", "testButton", []);
};
